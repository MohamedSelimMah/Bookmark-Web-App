...
export default function BookCard({ cover, title, author, isAdd, progress, onClick }) {
  if (isAdd) {
    return (
      <div className="w-28 min-w-[7rem] flex-shrink-0">
        <div
          className="rounded-md overflow-hidden shadow-md bg-[#eaf2f5] flex items-center justify-center h-46 border-2 border-dashed border-gray-300 cursor-pointer"
          onClick={onClick}
          tabIndex={0}
          role="button"
